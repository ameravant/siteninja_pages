...
namespace :admin do |admin|
  admin.resources :pages, :collection => { :reorder => :put, :ajax_index => :get, :insert_link => :get, :ajax_page_for_list => :get, :receive_drop => :get, :batch => :put, :footer => :get, :reorder_footer => :put, :preview => :get, :post_preview => :put, :ajax_preview => :get }, :has_many => [ :comments ] do |page|
