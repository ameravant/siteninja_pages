...
namespace :admin do |admin|
  admin.resources :pages, :collection => { :reorder => :put, :receive_drop => :get, :footer => :get, :reorder_footer => :put, :preview => :get, :post_preview => :put, :ajax_preview => :get }, :has_many => [ :comments ] do |page|
